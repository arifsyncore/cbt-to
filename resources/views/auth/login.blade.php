                ...
                <div class="card p-md-7 p-1">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="{{ url('/') }}" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-semibold">CBT-Online</span>
                        </a>
                    </div>
                    <!-- /Logo -->

                    <div class="card-body mt-1">
                        <h4 class="mb-1">CBT-Online! 👋</h4>
                        <p class="mb-5">Silahkan masuk ke akun anda</p>

                        <form id="formAuthentication" class="mb-5" action="{{ route('post-login') }}" method="POST">
                            @csrf
                        ...
                        <p class="text-center">
                            <span>Ingin buat akun baru ?</span>
                            <a href="{{ route('daftar') }}">
                                <span>Buat Akun</span>
                            </a>
                        </p>
